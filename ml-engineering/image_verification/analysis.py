...
def analyze_image_content(image_url: str = None, image_bytes: bytes = None, location_name: str = "") -> dict:
    """
    ...
    if not image_bytes:
        return _simulate(image_url, location_name=location_name)
...
def _simulate(image_url: str, location_name: str = "") -> dict:
