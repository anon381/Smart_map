...
from image_verification.real_photo_detector import detect_real_photo, _download_image
from image_verification.ocr_extractor       import extract_text_from_image
from image_verification.analysis            import analyze_image_content, score_scene_vs_category
...
def verify_location_image(
    ...
    ocr_result = extract_text_from_image(image_bytes or b"", location_name=location_name, image_url=image_url)
    results["ocr"] = {
    ...
    scene_result = analyze_image_content(image_url=image_url, image_bytes=image_bytes, location_name=location_name)
    ...
    name_result = match_name_to_image(location_name, ocr_result, category=category)
    results["name_match"] = {
