    ...
    <MainLayout>
        ...
        <div className="absolute left-[496px] top-[393px] flex flex-col items-center group pointer-events-auto">
          ...
          <div className="absolute bottom-full mb-2 bg-white shadow-2xl rounded-xl p-4 w-48 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col gap-2">
            <div className="flex justify-between items-start">
              <h4 className="text-sm font-bold text-zinc-900 leading-tight">Hidden Cafe</h4>
              <span className="bg-yellow-300 text-yellow-900 text-[10px] font-bold px-2 py-0.5 rounded">150 XP</span>
            </div>
            <p className="text-xs text-green-900">Unexplored terrain detected. Scan to unlock.</p>
          </div>
      ...
      <div className="absolute top-6 left-6 z-30">
        <div className="bg-green-50/90 backdrop-blur-md px-6 py-3 rounded-full flex gap-4 shadow-lg border border-green-200">
           <button className="text-sm font-bold text-green-800 uppercase tracking-wider">All</button>
           <button className="text-sm font-bold text-zinc-500 uppercase tracking-wider hover:text-green-700">Food</button>
           <button className="text-sm font-bold text-zinc-500 uppercase tracking-wider hover:text-green-700">Zones</button>
           <button className="text-sm font-bold text-zinc-500 uppercase tracking-wider hover:text-green-700">Gems</button>
        </div>
      </div>
    </MainLayout>
  );
