...
function RootComponent() {
  ...
  const previousPathnameRef = reactExports.useRef(pathname);
  ...
  const wasAuthRoute = authPaths.includes(
    previousPathname
  );
  const shouldFlip = isAuthRoute && wasAuthRoute && pathname !== previousPathname;
  const direction = previousPathname === "/signin" && pathname === "/signup" ? 1 : previousPathname === "/signup" && pathname === "/signin" ? -1 : 1;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: shouldFlip ? { perspective: "1400px" } : void 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      initial: shouldFlip ? { opacity: 0, rotateY: direction * 90, scale: 0.98 } : { opacity: 0, y: 12 },
      animate: shouldFlip ? { opacity: 1, rotateY: 0, scale: 1 } : { opacity: 1, y: 0 },
      exit: shouldFlip ? { opacity: 0, rotateY: direction * -90, scale: 0.98 } : { opacity: 0, y: -12 },
...
const $$splitComponentImporter$2 = () => import("./signup-b8Olup6F.js");
...
const $$splitComponentImporter$1 = () => import("./signin-BjnQbGXq.js");
...
const $$splitComponentImporter = () => import("./index-DXusqfNL.js");
...
export {
  ...
  motionValue as m,
  noop as n,
  hasReducedMotionListener as o,
  progress as p,
  initPrefersReducedMotion as q,
  resize as r,
  supportsViewTimeline as s,
  prefersReducedMotion as t,
  useNavigate as u,
