...
import { u as useNavigate, L as Link } from "./router-_-K0eT4h.js";
import { B as Button, A as ArrowRight } from "./button-DMUmqlHb.js";
import { A as AuthShell, M as Mail, L as Lock } from "./auth-shell-Cgmagv_y.js";
import "node:events";
...
function SignInPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AuthShell, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    "."
  ] }), description: "Sign in to pick up your missions where you left off.", footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-muted-foreground mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", className: "text-primary hover:text-primary-glow font-semibold transition-colors", children: "Sign up" }) })
  ] });
}
export {
